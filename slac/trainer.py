...
class Trainer:
    ...
    def __init__(
        ...
        self.ob = SlacObservation((3, 224, 224), (6,), (3,), num_sequences)
        self.ob_test = SlacObservation((3, 224, 224), (6,), (3,), num_sequences)
